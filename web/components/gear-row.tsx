  ...
  return (
    <div className="px-4 py-3 flex justify-between items-center w-full group hover:bg-slate-50 transition-colors">
      ...
      <div className="flex flex-col gap-0.5">
        <p className="font-medium text-slate-800 text-sm transition-colors">{item.name}</p>
        <p className="text-slate-500 text-xs truncate max-w-[200px] sm:max-w-xs md:max-w-md">{item.description}</p>
      </div>
